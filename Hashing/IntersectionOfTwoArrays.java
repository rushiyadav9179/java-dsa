...
public class IntersectionOfTwoArrays {
    ...
    public static void main(String[] args) {
        ...
        int[] nums1 = {1,2,8,3,5,4,3,2,1};
        int[] nums2 = {2,4,3,5,6,2};
...
// git add IntersectionOfTwoArrays.java
// git git commit -m "Solved Intersection of Two Arrays using sorting and two pointers"
// git push